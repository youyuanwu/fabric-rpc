...
public:
  ...
  public:
    Service(){};
    virtual ~Service(){};
    virtual fabricrpc::Status
    BeginSayHello(const FabricRequest *request,
                  IFabricAsyncOperationCallback *callback,
                  /*out*/ IFabricAsyncOperationContext **context) = 0;
    virtual fabricrpc::Status EndSayHello(IFabricAsyncOperationContext *context,
                                          /*out*/ FabricResponse *response) = 0;
    virtual fabricrpc::Status
